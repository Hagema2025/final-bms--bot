...
VENUE_MAP = {
    ...
    "KVCS":"KC(Krishnaveni Cinemas), TNAGAR",
    "RSSC":"Rohini Silver Screens, Koyambedu",
    "INTO": "INOX: The Marina Mall, OMR",
    "TVHP":"The Vijay Park Multiplex, Injambakkam ECR",
    "RRGB":"Rakki RGB Laser 4K, Thiruvallur",
    "MCXF":"Meenakshi Cinemas (Rakki), Avadi",
    "VVGT":"Vels Theatres, Chennai",
    "KSTK":"Kasi Talkies, Ashok Nagar",
    "MCSK":"Miraj Cinemas:Sekaran Mall, Perumbakkam",
