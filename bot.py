...
async def auto_delete_all_service_messages(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Instantly deletes all service messages, pins, joins, leaves, and forum topic events."""
    if update.message:
        try:
...
STATE_SHOW_URL: [MessageHandler(filters.TEXT & ~filters.COMMAND, receive_show_url)],
    ...
    # Combine standard service updates and forum-specific events
    comprehensive_service_filter = filters.MessageFilter(lambda m: bool(
